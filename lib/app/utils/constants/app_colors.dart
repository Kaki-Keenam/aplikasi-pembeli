...
class AppColor {
  static Color primary = Color(0xFFFFB300);
  static Color primarySoft = Color(0xFFFF6F00);
  static Color primaryExtraSoft = Color(0xFFEEF4F4);
  static Color secondary = Color(0xFFEDE5CC);
  static Color thirdSoft = Color(0xFFFFECB3);
  static Color whiteSoft = Color(0xFFF8F8F8);
  static LinearGradient bottomShadow = LinearGradient(colors: [Color(0xFFFFB300).withOpacity(0.2), Color(0xFFFFB300).withOpacity(0)], begin: Alignment.bottomCenter, end: Alignment.topCenter);
